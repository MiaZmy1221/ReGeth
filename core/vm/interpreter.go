...
type Interpreter interface {
	...
	RunWithFlag(contract *Contract, input []byte, static bool, redundency bool) ([]byte, error)
...
func (in *EVMInterpreter) Run(contract *Contract, input []byte, readOnly bool) (ret []byte, err error) {
	...
	for atomic.LoadInt32(&in.evm.abort) == 0 {
		...
		res, _, err = operation.execute(&pc, in, contract, mem, stack)
...
func (in *EVMInterpreter) RunWithFlag(contract *Contract, input []byte, readOnly bool, redundency bool) (ret []byte, err error) {
	if in.intPool == nil {
		in.intPool = poolOfIntPools.get()
		defer func() {
			poolOfIntPools.put(in.intPool)
